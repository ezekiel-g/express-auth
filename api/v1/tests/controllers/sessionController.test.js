...
describe('sessionController', () => {
  ...
  describe('createSession', () => {
    it(
      'signs in successfully and sets tokens ' + 'when credentials are valid',
      async () => {
  ...
  describe('refreshSession', () => {
    ...
    it(
      'returns 200 and set new access token cookie ' +
  ...
  describe('verifyTotp', () => {
    ...
    it('returns 401 if TOTP is invalid', async () => {
      ...
      encryptionHelper.decryptTotpSecret.mockReturnValue('decryptedSecret');
