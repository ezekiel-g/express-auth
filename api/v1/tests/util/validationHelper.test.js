import { describe, it, expect, afterEach, jest }
    from '@jest/globals'
    ...
    describe('returnSuccess', () => {
        it('returns success message when current value is different', () => {
            const validationResult =
                validationHelper.returnSuccess('Username', 'User1', 'User2')
        ...
        it('returns no message when current value is the same', () => {
            const validationResult =
                validationHelper.returnSuccess('Username', 'User1', 'User1')
        ...
        it('returns no message if current value is null', () => {
            const validationResult =
                validationHelper.returnSuccess('Username', 'User1', null)
        ...
        it('returns no message if current value is undefined', () => {
            const validationResult =
                validationHelper.returnSuccess('Username', 'User1', undefined)
