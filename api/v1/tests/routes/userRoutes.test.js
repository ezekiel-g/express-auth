...
beforeEach(() => {
    userController.readUsers.mockImplementation((request, response) => {
    ...
    userController.readUser.mockImplementation((request, response) => {
        response.status(200).json({
    ...
    userController.deleteUser.mockImplementation(
        (request, response) => {
            response
                .status(200)
